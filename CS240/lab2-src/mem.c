...
/*  mymemdump(stdout, (char*) head, 128);*/
 ...
 mymemdump(stdout, (char *) str,16);
 printf("\n");
 mymemdump(stdout, (char *) &a,16);
 printf("\n");
 mymemdump(stdout, (char *) &b,16);
 printf("\n");
 mymemdump(stdout, (char *) &y,16);
 printf("\n");
 mymemdump(stdout, (char *) &x.a,16);
 printf("\n");
 mymemdump(stdout, (char *) &x.i,16);
 printf("\n");
 mymemdump(stdout, (char *) &x.b,16);
 printf("\n");
 mymemdump(stdout, (char *) x.p,16);
 printf("\n");
 mymemdump(stdout, (char *) head,16);
 printf("\n");
 mymemdump(stdout, (char *) head->str,16);
 printf("\n");
 mymemdump(stdout, (char *) head->next,16);
 printf("\n");
 mymemdump(stdout, (char *) head->next->str,16);
 printf("\n");
 mymemdump(stdout, (char *) head->next->next,16);
 printf("\n");
 mymemdump(stdout, (char *) head->next->next->str,16);
 printf("\n");
 mymemdump(stdout, (char *) head->next->next->next,16);
 printf("\n");
