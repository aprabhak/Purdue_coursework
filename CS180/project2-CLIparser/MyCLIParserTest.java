...
public class MyCLIParserTest extends TestCase {
    ...
    public void testAdd_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-add", "k"});
    ...
    public void testSub_00() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-sub", "5", "2"});
        assertTrue(outContent.toString().matches("3\\r?\\n"));
    }
    ...
    public void testSub_01() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-sub", "6"});
        assertTrue(outContent.toString().matches("Argument count mismatch\\r?\\n"));
    }
    ...
    public void testSub_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-sub", "k"});
        assertTrue(outContent.toString().matches("Argument count mismatch\\r?\\n"));
    }
    ...
    public void testMul_00() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-mul", "2", "4", "6"});
        assertTrue(outContent.toString().matches("48\\r?\\n"));
    }
    ...
    public void testMul_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-mul", "k"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
    ...
    public void testDiv_00() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "10" ,"2"});
        assertTrue(outContent.toString().matches("5.00\\r?\\n"));
    }
    ...
    public void testDiv_01() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "5"});
        assertTrue(outContent.toString().matches("Argument count mismatch\\r?\\n"));
    }
    ...
    public void testDiv_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "k"});
        assertTrue(outContent.toString().matches("Argument count mismatch\\r?\\n"));
    }
    ...
    public void testDiv_04() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-div", "5", "0"});
    ...
    public void testStats_00() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-stats", "5", "10", "15"});
        assertTrue(outContent.toString().matches("30\\r?\\n15\\r?\\n5\\r?\\n10.00\\r?\\n"));
    }
    ...
    public void testStats_03() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-stats", "k"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
    ...
    public void testTable_02() {
        // CODE HERE
        MyCLIParser.main(new String[]{"-table", "k"});
        assertTrue(outContent.toString().matches("Argument type mismatch\\r?\\n"));
    }
